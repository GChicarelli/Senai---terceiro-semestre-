...
namespace VHBurguer.Applications.Services
{
    public class ProdutoService
    {
        ...
        // Cria um DTO só com o que a requisição/front precisa
        ...
        private static void ValidarCadastro(CriarProdutoDto produtoDto)
        {
            ...
            {
                throw new DomainException("Descricao é obrigatória.");
            }
        ...
        public LerProdutoDto Atualizar(int id, AtualizarProdutoDto produtoDto)
        {
            ...
            {
                throw new DomainException("Produto não foi encontrado.");
            }

            // produtoIdAtual: - Serve para passar o valor atual do parâmetro 
